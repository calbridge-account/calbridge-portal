...
CREATE TABLE IF NOT EXISTS dsp_campaign_report (
  ...
  viewable_impressions                 NUMBER,
  viewability_rate                     FLOAT,
  video_ad_start                       NUMBER,
  video_ad_first_quartile              NUMBER,
  video_ad_midpoint                    NUMBER,
  video_ad_third_quartile              NUMBER,
  video_ad_complete                    NUMBER,
  synced_at                            TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (advertiser_id, profile_id, date, order_id)
);

CREATE TABLE IF NOT EXISTS dsp_order_report (
  advertiser_id                        VARCHAR(64)   NOT NULL,
  profile_id                           VARCHAR(36)   NOT NULL,
  client_id                            VARCHAR(36),
  date                                 DATE          NOT NULL,
...
CREATE TABLE IF NOT EXISTS dsp_line_item_report (
  advertiser_id                        VARCHAR(64)   NOT NULL,
  profile_id                           VARCHAR(36)   NOT NULL,
  client_id                            VARCHAR(36),
  date                                 DATE          NOT NULL,
  line_item_id                         VARCHAR(64)   NOT NULL DEFAULT '',
  line_item_name                       VARCHAR(512),
  order_id                             VARCHAR(64),
  order_name                           VARCHAR(512),
  impressions                          NUMBER,
  ...
  video_ad_complete                    NUMBER,
  synced_at                            TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (advertiser_id, profile_id, date, line_item_id)
);

CREATE TABLE IF NOT EXISTS dsp_audience_report (
  advertiser_id                        VARCHAR(64)   NOT NULL,
  profile_id                           VARCHAR(36)   NOT NULL,
  client_id                            VARCHAR(36),
  date                                 DATE          NOT NULL,
  ...
  add_to_cart                          NUMBER,
  synced_at                            TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (advertiser_id, profile_id, date, audience_id, order_id)
);

CREATE TABLE IF NOT EXISTS dsp_product_report (
  advertiser_id                        VARCHAR(64)   NOT NULL,
  profile_id                           VARCHAR(36)   NOT NULL,
  client_id                            VARCHAR(36),
  date                                 DATE          NOT NULL,
  ...
  add_to_cart                          NUMBER,
  synced_at                            TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (advertiser_id, profile_id, date, asin, order_id)
);
