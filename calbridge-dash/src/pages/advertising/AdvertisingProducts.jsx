        ...
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.map((r, i) => (
                  <tr key={r.asin + i} className={`border-b border-gray-50 hover:bg-gray-50 ${i % 2 === 1 ? 'bg-gray-50/40' : ''}`}>
                    ...
                    <td className="py-2.5 px-3 text-gray-800 max-w-xs" title={r.productTitle}>
                      <span className="block truncate max-w-[260px] font-medium">{r.productTitle}</span>
                    </td>
